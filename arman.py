...
bot = telebot.TeleBot('7417482043:AAE5yezjR1guFbHot51VHTlRZnW8l7qnSww')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @ARMANMODXOWNER."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @ARMANMODXOWNER 🙇."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙞𝙨 𝙤𝙣𝙡𝙮 𝙛𝙤𝙧 𝙥𝙖𝙞𝙙 𝙪𝙨𝙚𝙧𝙨 𝙗𝙪𝙮 𝙣𝙤𝙬 𝙛𝙧𝙤𝙢 - @ARMANMODXOWNER \n205 KALA JADU "
        bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"🔥      𝘼𝙏𝙏𝘼𝘾𝙆 𝙄𝙉𝙄𝙏𝙄𝘼𝙏𝙀𝘿..... 🔥\n💢 𝙎𝙄𝙂𝙈𝘼 𝙎𝙏𝙍𝙄𝙆𝙀 𝙄𝙉 𝙀𝙁𝙁𝙀𝘾𝙏 💢\n\n🎯 𝙏𝘼𝙍𝙂𝙀𝙏 𝙎𝙀𝙏 :-->   [ {target} ] ⚡\n🔐 𝙋𝙊𝙍𝙏 𝘼𝘾𝘾𝙀𝙎𝙎𝙀𝘿 :-->  [ {port} ] 🔥\n⌛𝘿𝙐𝙍𝘼𝙏𝙄𝙊𝙉 𝙇𝙊𝘾𝙆𝙀𝘿 :-->   [ {time} ] ⏲️\n🎮 𝐆𝐀𝐌𝐄 :--> 𝐁𝐆𝐌𝐈 🥹\n👩🏻‍💻 𝘼𝙏𝙏𝘼𝘾𝙆𝙀𝘿 𝘽𝙔𝙀 :--> 𝘼𝙍𝙈𝘼𝙉 𝙏𝙀𝘼𝙈\n\n🌪️ 𝐔𝐍𝐋𝐄𝐀𝐒𝐇𝐈𝐍𝐆 𝐅𝐎𝐑𝐂𝐄 𝐍𝐎 𝐓𝐔𝐑𝐍𝐈𝐍𝐆 𝐁𝐀𝐂𝐊 💂🏻‍♀️\n\n🔋𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘𝐄 :--) 🌟 𝐀𝐑𝐌𝐀𝐌 𝐓𝐄𝐀𝐌 🌟\n\nᴅᴇᴠᴇʟᴏᴘᴇʀ :--> @ARMANMODXOWNER"
    bot.reply_to(message, response)
